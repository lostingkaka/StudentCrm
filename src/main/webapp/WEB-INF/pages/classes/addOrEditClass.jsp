    ...
    <table width="88%" border="0" class="emp_table" style="width:80%;">
        ...
        <tr>
            ...
            <td>
                ...
                <s:textfield name="beginTime" readonly="true" onfocus="c.showMoreDay=true; c.show(this);"
                             value="%{#myBeginTime}"></s:textfield>
            </td>
            <td>结业时间：</td>
            <td>
                <s:date name='endTime' format='yyyy-MM-dd' var="myEndTime"/>
                <s:textfield name="endTime" readonly="true" onfocus="c.showMoreDay=true; c.show(this);"
                             value="%{#myEndTime}"></s:textfield>
            </td>
        </tr>
        <tr>
            <td>其他说明：</td>
