                                    ...
                                    <div align="right">
                                        <table border="0" width="215" cellspacing="0" cellpadding="0" id="table6"
                                            ...
                                            <tr>
                                                ...
                                                <td width="51" valign="middle"><font color="#FFFFFF"/><a
                                                        href="javascript:modifypsw();"><font color="ffffff">更改口令</font></a>
                                                </td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" height="10" id="table3">
    <tr>
        <td style="border-bottom: 1px solid #ffffff; filter:
        progid:dximagetransform.microsoft.gradient(startcolorstr='#0075C4', endcolorstr='#ffffff', gradienttype='1')">
            　
        </td>
    </tr>
</table>
